...
import com.haomi.mantou.base.loopj.requestdata.ReqUpdateLocation;
...
public class BdLocationUtil {
	...
	private BdLocationUtil() {
		...
		mContext = MantouApplication.getInstance().getApplicationContext();
		init();
	}

	static BdLocationUtil mBdLocationUtil;
	...
	private void init() {
		mLocationClient = new LocationClient(MantouApplication.getInstance().getApplicationContext());
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            logMsg(sb.toString());
            Log.i("lbs", sb.toString());
            
            new CommonRequestWrap(mContext, new ReqUpdateLocation(location.getLongitude()+"", location.getLatitude()+""), new RequestDelegate()).getRequest();
    ...
    private class RequestDelegate extends CommonRequestWrapDelegateAbstractImpl {
		...
		public void requestServerSuccess(CommonResultVo resultVo) {
			Log.i("lbs", "requestServerSuccess");
